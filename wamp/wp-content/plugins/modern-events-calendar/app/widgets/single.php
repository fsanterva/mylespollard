...
?>
		<ul class="mec-sortable">
			...
			<li>
				...
				<label for="<?php echo $this->get_field_id('next_module'); ?>"><?php _e('Next Event', 'mec'); ?></label>
			</li>
			<li>
			...
			<li>
				...
				<label for="<?php echo $this->get_field_id('virtual_events_module'); ?>"><?php _e('Virtual Event', 'mec'); ?></label>
			</li>
			<?php endif;  ?>
		</ul>
<?php
