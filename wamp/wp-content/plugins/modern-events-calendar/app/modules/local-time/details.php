...
<div class="mec-local-time-details mec-frontbox" id="mec_local_time_details">
    ...
    <ul>
        ...
        <li><?php echo sprintf(__('Time: %s', 'mec'), '<span>'.($allday ? $this->m('all_day', __('All Day' , 'mec')) : ($hide_end_time ? date($time_format, $user_start_time) : date($time_format, $user_start_time).' - '.date($time_format, $user_end_time))).'</span>'); ?></li>
        <?php endif; ?>
    </ul>
</div>