...
<div id="mec_book_payment_form" class="mec-booking-form-container mec-wrap-checkout row">
    ...
    <?php if ($mecFluentEnable) { ?>
            <?php if ($ticketsDetails) { ?>
                <div class="mec-book-available-tickets-details">
                    <div class="mec-book-available-tickets-details-header">
                        <span><?php esc_html_e('Ticket(s) Name', 'mec'); ?></span>
                        <span><?php esc_html_e('Qty', 'mec'); ?></span>
                        <span><?php esc_html_e('Price', 'mec'); ?></span>
                    </div>
            ...
            <div class="mec-book-price-total">
                <span class="mec-book-price-total-description"><?php esc_html_e('Total Due', 'mec'); ?></span>
    ...
    <div class="mec-book-form-coupon">
        <form id="mec_book_form_coupon<?php echo $uniqueid; ?>" onsubmit="mec_book_apply_coupon<?php echo $uniqueid; ?>(); return false;">
            <input type="text" name="coupon" title="<?php esc_attr_e('Discount Coupon'); ?>" placeholder="<?php esc_attr_e('Discount Coupon', 'mec'); ?>" />
    ...
    <button id="mec-book-form-back-btn-step-3" class="mec-book-form-back-button" type="button" onclick="mec_book_form_back_btn_click(this);"><?php _e('Back', 'mec'); ?></button>
    <form id="mec_book_form_free_booking<?php echo $uniqueid; ?>" class="mec-util-hidden mec-click-next" onsubmit="mec_book_free<?php echo $uniqueid; ?>(); return false;">
        <div class="mec-form-row">
            ...
            <button class="mec-book-form-next-button" type="submit"><?php _e('Free Booking', 'mec'); ?></button>
        </div>
    </form>
</div>