...
<div class="mec-next-event-details mec-frontbox" id="mec_next_event_details">
    <div class="mec-next-<?php echo $method; ?>">
        ...
        <ul>
            <li>
                <a href="<?php echo $this->get_event_date_permalink($next, $next_date['start']['date'], true, $next_time); ?>"><?php echo ($method == 'occurrence' ? __('Go to occurrence page', 'mec') : $next->data->title); ?></a>
            </li>
            <li>
            ...
            <li>
                ...
                <?php else: ?>
                <dd><abbr class="mec-events-abbr"><?php echo $this->m('all_day', __('All Day' , 'mec')); ?></abbr></dd>
                <?php endif; ?>
            </li>
        </ul>
    </div>
