                ...
                <div class="mec-form-row">
                    <ul id="mec_orgz_form_row" class="mec-additional-organizers-list">
                        ...
                        <li>
                            ...
                            <span class="mec-additional-organizer-sort"><?php echo __('Sort', 'mec'); ?></span>
                            <span onclick="mec_additional_organizers_remove(this);" class="mec-additional-organizer-remove"><?php echo __('Remove', 'mec'); ?></span>
