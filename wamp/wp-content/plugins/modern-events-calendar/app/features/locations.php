...
class MEC_feature_locations extends MEC_base
{
    ...
    ?>
        ...
        <tr class="form-field">
            <th scope="row">
                <label for="mec_url"><?php _e('Location Website', 'mec'); ?></label>
            </th>
            <td>
                <input type="url" placeholder="<?php esc_attr_e('Location Website (Optional)', 'mec'); ?>" name="url" id="mec_url" value="<?php echo $url; ?>" />
            </td>
        </tr>
    ...
    ?>
        ...
        <div class="form-field">
            <label for="mec_url"><?php _e('Location Website', 'mec'); ?></label>
            <input type="url" name="url"  placeholder="<?php esc_attr_e('Location Website (Optional)', 'mec'); ?>" id="mec_url" value="" />
        </div>
    ...
    ?>
        <div class="mec-meta-box-fields mec-event-tab-content" id="mec-location">
			...
			<div id="mec_location_new_container">
                ...
                <div class="mec-form-row">
                    <input type="url" name="mec[location][url]" id="mec_location_url" value="" placeholder="<?php _e('Location Website', 'mec'); ?>" />
                </div>
