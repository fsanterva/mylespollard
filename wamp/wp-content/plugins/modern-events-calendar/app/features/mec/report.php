        ...
        <div class="mec-report-wrap">
                            ...
                            <?php 
                                if($query->have_posts())
                                {
                                    ...
                                    while($query->have_posts())
                                    {
                                        ...
                                        echo '<option value="'.$ID.'">' . sprintf(__('%s (from %s)', 'mec'), get_the_title(), date($date_format, strtotime($start_date))) . '</option>';
                                    }
                                }
                            ?>
                        </select>
            ...
            <div class="mec-report-sendmail-form-wrap"><div class="w-row"><div class="w-col-sm-12">
                ...
                <div class="mec-send-email-form-wrap">
                    ...
                    <br>
                    <label><input type="checkbox" id="mec-send-admin-copy" value="1"><?php echo __('Send a copy to admin', 'mec'); ?></label>
                    <br><br><p class="description"><?php echo __('You can use the following placeholders', 'mec'); ?></p>
                    <ul>
