    ...
    <div class="mec-meta-box-fields" id="mec_meta_box_calendar_search_form_options">
        ...
        <div class="mec-search-forms-options-container">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_list_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][list][category][type]" id="mec_sf_list_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_list['category']) and isset($sf_options_list['category']['type']) and $sf_options_list['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_list_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][list][address_search][type]" id="mec_sf_list_address_search">
						<option value="0" <?php if(isset($sf_options_list['address_search']) and isset($sf_options_list['address_search']['type']) and $sf_options_list['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_list['address_search']) and isset($sf_options_list['address_search']['type']) and $sf_options_list['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_list_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][list][event_cost][type]" id="mec_sf_list_event_cost">
                        <option value="0" <?php if(isset($sf_options_list['event_cost']) and isset($sf_options_list['event_cost']['type']) and $sf_options_list['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_list['event_cost']) and isset($sf_options_list['event_cost']['type']) and $sf_options_list['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_list_month_filter"><?php _e('Date Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][list][month_filter][type]" id="mec_sf_list_month_filter">
                        ...
                        <option value="dropdown" <?php if(isset($sf_options_list['month_filter']) and isset($sf_options_list['month_filter']['type']) and $sf_options_list['month_filter']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Year & Month Dropdown', 'mec'); ?></option>
                        <option value="date-range-picker" <?php if(isset($sf_options_list['month_filter']) and isset($sf_options_list['month_filter']['type']) and $sf_options_list['month_filter']['type'] == 'date-range-picker') echo 'selected="selected"'; ?>><?php _e('Date Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_list_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][list][time_filter][type]" id="mec_sf_list_time_filter">
                        <option value="0" <?php if(isset($sf_options_list['time_filter']) and isset($sf_options_list['time_filter']['type']) and $sf_options_list['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_list['time_filter']) and isset($sf_options_list['time_filter']['type']) and $sf_options_list['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_grid_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][grid][category][type]" id="mec_sf_grid_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_grid['category']) and isset($sf_options_grid['category']['type']) and $sf_options_grid['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_grid_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][grid][address_search][type]" id="mec_sf_grid_address_search">
						<option value="0" <?php if(isset($sf_options_grid['address_search']) and isset($sf_options_grid['address_search']['type']) and $sf_options_grid['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_grid['address_search']) and isset($sf_options_grid['address_search']['type']) and $sf_options_grid['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_grid_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][grid][event_cost][type]" id="mec_sf_grid_event_cost">
                        <option value="0" <?php if(isset($sf_options_grid['event_cost']) and isset($sf_options_grid['event_cost']['type']) and $sf_options_grid['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_grid['event_cost']) and isset($sf_options_grid['event_cost']['type']) and $sf_options_grid['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_grid_month_filter"><?php _e('Date Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][grid][month_filter][type]" id="mec_sf_grid_month_filter">
                        ...
                        <option value="dropdown" <?php if(isset($sf_options_grid['month_filter']) and isset($sf_options_grid['month_filter']['type']) and $sf_options_grid['month_filter']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Year & Month Dropdown', 'mec'); ?></option>
                        <option value="date-range-picker" <?php if(isset($sf_options_grid['month_filter']) and isset($sf_options_grid['month_filter']['type']) and $sf_options_grid['month_filter']['type'] == 'date-range-picker') echo 'selected="selected"'; ?>><?php _e('Date Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_grid_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][grid][time_filter][type]" id="mec_sf_grid_time_filter">
                        <option value="0" <?php if(isset($sf_options_grid['time_filter']) and isset($sf_options_grid['time_filter']['type']) and $sf_options_grid['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_grid['time_filter']) and isset($sf_options_grid['time_filter']['type']) and $sf_options_grid['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_agenda_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][agenda][category][type]" id="mec_sf_agenda_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_agenda['category']) and isset($sf_options_agenda['category']['type']) and $sf_options_agenda['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_agenda_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][agenda][address_search][type]" id="mec_sf_agenda_address_search">
						<option value="0" <?php if(isset($sf_options_agenda['address_search']) and isset($sf_options_agenda['address_search']['type']) and $sf_options_agenda['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_agenda['address_search']) and isset($sf_options_agenda['address_search']['type']) and $sf_options_agenda['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_agenda_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][agenda][event_cost][type]" id="mec_sf_agenda_event_cost">
                        <option value="0" <?php if(isset($sf_options_agenda['event_cost']) and isset($sf_options_agenda['event_cost']['type']) and $sf_options_agenda['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_agenda['event_cost']) and isset($sf_options_agenda['event_cost']['type']) and $sf_options_agenda['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_agenda_month_filter"><?php _e('Date Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][agenda][month_filter][type]" id="mec_sf_agenda_month_filter">
                        ...
                        <option value="dropdown" <?php if(isset($sf_options_agenda['month_filter']) and isset($sf_options_agenda['month_filter']['type']) and $sf_options_agenda['month_filter']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Year & Month Dropdown', 'mec'); ?></option>
                        <option value="date-range-picker" <?php if(isset($sf_options_agenda['month_filter']) and isset($sf_options_agenda['month_filter']['type']) and $sf_options_agenda['month_filter']['type'] == 'date-range-picker') echo 'selected="selected"'; ?>><?php _e('Date Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_agenda_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][agenda][time_filter][type]" id="mec_sf_agenda_time_filter">
                        <option value="0" <?php if(isset($sf_options_agenda['time_filter']) and isset($sf_options_agenda['time_filter']['type']) and $sf_options_agenda['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_agenda['time_filter']) and isset($sf_options_agenda['time_filter']['type']) and $sf_options_agenda['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_full_calendar_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][full_calendar][category][type]" id="mec_sf_full_calendar_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_full_calendar['category']) and isset($sf_options_full_calendar['category']['type']) and $sf_options_full_calendar['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_full_calendar_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][full_calendar][address_search][type]" id="mec_sf_full_calendar_address_search">
						<option value="0" <?php if(isset($sf_options_full_calendar['address_search']) and isset($sf_options_full_calendar['address_search']['type']) and $sf_options_full_calendar['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_full_calendar['address_search']) and isset($sf_options_full_calendar['address_search']['type']) and $sf_options_full_calendar['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_full_calendar_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][full_calendar][event_cost][type]" id="mec_sf_full_calendar_event_cost">
                        <option value="0" <?php if(isset($sf_options_full_calendar['event_cost']) and isset($sf_options_full_calendar['event_cost']['type']) and $sf_options_full_calendar['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_full_calendar['event_cost']) and isset($sf_options_full_calendar['event_cost']['type']) and $sf_options_full_calendar['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_full_calendar_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][full_calendar][time_filter][type]" id="mec_sf_full_calendar_time_filter">
                        <option value="0" <?php if(isset($sf_options_full_calendar['time_filter']) and isset($sf_options_full_calendar['time_filter']['type']) and $sf_options_full_calendar['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_full_calendar['time_filter']) and isset($sf_options_full_calendar['time_filter']['type']) and $sf_options_full_calendar['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_monthly_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][monthly_view][category][type]" id="mec_sf_monthly_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_monthly_view['category']) and isset($sf_options_monthly_view['category']['type']) and $sf_options_monthly_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_monthly_view_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][monthly_view][address_search][type]" id="mec_sf_monthly_view_address_search">
						<option value="0" <?php if(isset($sf_options_monthly_view['address_search']) and isset($sf_options_monthly_view['address_search']['type']) and $sf_options_monthly_view['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_monthly_view['address_search']) and isset($sf_options_monthly_view['address_search']['type']) and $sf_options_monthly_view['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_monthly_view_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][monthly_view][event_cost][type]" id="mec_sf_monthly_view_event_cost">
                        <option value="0" <?php if(isset($sf_options_monthly_view['event_cost']) and isset($sf_options_monthly_view['event_cost']['type']) and $sf_options_monthly_view['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_monthly_view['event_cost']) and isset($sf_options_monthly_view['event_cost']['type']) and $sf_options_monthly_view['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_monthly_view_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][monthly_view][time_filter][type]" id="mec_sf_monthly_view_time_filter">
                        <option value="0" <?php if(isset($sf_options_monthly_view['time_filter']) and isset($sf_options_monthly_view['time_filter']['type']) and $sf_options_monthly_view['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_monthly_view['time_filter']) and isset($sf_options_monthly_view['time_filter']['type']) and $sf_options_monthly_view['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_yearly_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][yearly_view][category][type]" id="mec_sf_yearly_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_yearly_view['category']) and isset($sf_options_yearly_view['category']['type']) and $sf_options_yearly_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_yearly_view_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][yearly_view][address_search][type]" id="mec_sf_yearly_view_address_search">
						<option value="0" <?php if(isset($sf_options_yearly_view['address_search']) and isset($sf_options_yearly_view['address_search']['type']) and $sf_options_yearly_view['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_yearly_view['address_search']) and isset($sf_options_yearly_view['address_search']['type']) and $sf_options_yearly_view['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_yearly_view_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][yearly_view][event_cost][type]" id="mec_sf_yearly_view_event_cost">
                        <option value="0" <?php if(isset($sf_options_yearly_view['event_cost']) and isset($sf_options_yearly_view['event_cost']['type']) and $sf_options_yearly_view['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_yearly_view['event_cost']) and isset($sf_options_yearly_view['event_cost']['type']) and $sf_options_yearly_view['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_yearly_view_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][yearly_view][time_filter][type]" id="mec_sf_yearly_view_time_filter">
                        <option value="0" <?php if(isset($sf_options_yearly_view['time_filter']) and isset($sf_options_yearly_view['time_filter']['type']) and $sf_options_yearly_view['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_yearly_view['time_filter']) and isset($sf_options_yearly_view['time_filter']['type']) and $sf_options_yearly_view['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_map_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][map][category][type]" id="mec_sf_map_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_map['category']) and isset($sf_options_map['category']['type']) and $sf_options_map['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_map_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][map][address_search][type]" id="mec_sf_map_address_search">
						<option value="0" <?php if(isset($sf_options_map['address_search']) and isset($sf_options_map['address_search']['type']) and $sf_options_map['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_map['address_search']) and isset($sf_options_map['address_search']['type']) and $sf_options_map['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_map_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][map][event_cost][type]" id="mec_sf_map_event_cost">
                        <option value="0" <?php if(isset($sf_options_map['event_cost']) and isset($sf_options_map['event_cost']['type']) and $sf_options_map['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_map['event_cost']) and isset($sf_options_map['event_cost']['type']) and $sf_options_map['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_daily_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][daily_view][category][type]" id="mec_sf_daily_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_daily_view['category']) and isset($sf_options_daily_view['category']['type']) and $sf_options_daily_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_daily_view_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][daily_view][address_search][type]" id="mec_sf_daily_view_address_search">
						<option value="0" <?php if(isset($sf_options_daily_view['address_search']) and isset($sf_options_daily_view['address_search']['type']) and $sf_options_daily_view['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_daily_view['address_search']) and isset($sf_options_daily_view['address_search']['type']) and $sf_options_daily_view['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_daily_view_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][daily_view][event_cost][type]" id="mec_sf_daily_view_event_cost">
                        <option value="0" <?php if(isset($sf_options_daily_view['event_cost']) and isset($sf_options_daily_view['event_cost']['type']) and $sf_options_daily_view['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_daily_view['event_cost']) and isset($sf_options_daily_view['event_cost']['type']) and $sf_options_daily_view['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_daily_view_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][daily_view][time_filter][type]" id="mec_sf_daily_view_time_filter">
                        <option value="0" <?php if(isset($sf_options_daily_view['time_filter']) and isset($sf_options_daily_view['time_filter']['type']) and $sf_options_daily_view['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_daily_view['time_filter']) and isset($sf_options_daily_view['time_filter']['type']) and $sf_options_daily_view['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_weekly_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][weekly_view][category][type]" id="mec_sf_weekly_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_weekly_view['category']) and isset($sf_options_weekly_view['category']['type']) and $sf_options_weekly_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_weekly_view_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][weekly_view][address_search][type]" id="mec_sf_weekly_view_address_search">
						<option value="0" <?php if(isset($sf_options_weekly_view['address_search']) and isset($sf_options_weekly_view['address_search']['type']) and $sf_options_weekly_view['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_weekly_view['address_search']) and isset($sf_options_weekly_view['address_search']['type']) and $sf_options_weekly_view['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_weekly_view_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][weekly_view][event_cost][type]" id="mec_sf_weekly_view_event_cost">
                        <option value="0" <?php if(isset($sf_options_weekly_view['event_cost']) and isset($sf_options_weekly_view['event_cost']['type']) and $sf_options_weekly_view['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_weekly_view['event_cost']) and isset($sf_options_weekly_view['event_cost']['type']) and $sf_options_weekly_view['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_weekly_view_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][weekly_view][time_filter][type]" id="mec_sf_weekly_view_time_filter">
                        <option value="0" <?php if(isset($sf_options_weekly_view['time_filter']) and isset($sf_options_weekly_view['time_filter']['type']) and $sf_options_weekly_view['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_weekly_view['time_filter']) and isset($sf_options_weekly_view['time_filter']['type']) and $sf_options_weekly_view['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_timetable_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][timetable][category][type]" id="mec_sf_timetable_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_timetable['category']) and isset($sf_options_timetable['category']['type']) and $sf_options_timetable['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_timetable_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][timetable][address_search][type]" id="mec_sf_timetable_address_search">
						<option value="0" <?php if(isset($sf_options_timetable['address_search']) and isset($sf_options_timetable['address_search']['type']) and $sf_options_timetable['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_timetable['address_search']) and isset($sf_options_timetable['address_search']['type']) and $sf_options_timetable['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_timetable_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][timetable][event_cost][type]" id="mec_sf_timetable_event_cost">
                        <option value="0" <?php if(isset($sf_options_timetable['event_cost']) and isset($sf_options_timetable['event_cost']['type']) and $sf_options_timetable['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_timetable['event_cost']) and isset($sf_options_timetable['event_cost']['type']) and $sf_options_timetable['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_timetable_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][timetable][time_filter][type]" id="mec_sf_timetable_time_filter">
                        <option value="0" <?php if(isset($sf_options_timetable['time_filter']) and isset($sf_options_timetable['time_filter']['type']) and $sf_options_timetable['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_timetable['time_filter']) and isset($sf_options_timetable['time_filter']['type']) and $sf_options_timetable['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_tile_search_form_options_container">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_category"><?php echo $this->main->m('taxonomy_category', __('Category', 'mec')); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][category][type]" id="mec_sf_tile_category">
                        <option value="0" <?php if(isset($sf_options_tile['category']) and isset($sf_options_tile['category']['type']) and $sf_options_tile['category']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['category']) and isset($sf_options_tile['category']['type']) and $sf_options_tile['category']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                        <option value="checkboxes" <?php if(isset($sf_options_tile['category']) and isset($sf_options_tile['category']['type']) and $sf_options_tile['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Checkboxes', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_location"><?php echo $this->main->m('taxonomy_location', __('Location', 'mec')); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][location][type]" id="mec_sf_tile_location">
                        <option value="0" <?php if(isset($sf_options_tile['location']) and isset($sf_options_tile['location']['type']) and $sf_options_tile['location']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['location']) and isset($sf_options_tile['location']['type']) and $sf_options_tile['location']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                    </select>
                </div>
                <?php do_action('mec_sf_options_location',array('skin'=>'tile' ,'options'=>$sf_options_tile)); ?>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_organizer"><?php echo $this->main->m('taxonomy_organizer', __('Organizer', 'mec')); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][organizer][type]" id="mec_sf_tile_organizer">
                        <option value="0" <?php if(isset($sf_options_tile['organizer']) and isset($sf_options_tile['organizer']['type']) and $sf_options_tile['organizer']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['organizer']) and isset($sf_options_tile['organizer']['type']) and $sf_options_tile['organizer']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_speaker"><?php echo $this->main->m('taxonomy_speaker', __('Speaker', 'mec')); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][speaker][type]" id="mec_sf_tile_speaker">
                        <option value="0" <?php if(isset($sf_options_tile['speaker']) and isset($sf_options_tile['speaker']['type']) and $sf_options_tile['speaker']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['speaker']) and isset($sf_options_tile['speaker']['type']) and $sf_options_tile['speaker']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_tag"><?php echo $this->main->m('taxonomy_tag', __('Tag', 'mec')); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][tag][type]" id="mec_sf_tile_tag">
                        <option value="0" <?php if(isset($sf_options_tile['tag']) and isset($sf_options_tile['tag']['type']) and $sf_options_tile['tag']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['tag']) and isset($sf_options_tile['tag']['type']) and $sf_options_tile['tag']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_label"><?php echo $this->main->m('taxonomy_label', __('Label', 'mec')); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][label][type]" id="mec_sf_tile_label">
                        <option value="0" <?php if(isset($sf_options_tile['label']) and isset($sf_options_tile['label']['type']) and $sf_options_tile['label']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['label']) and isset($sf_options_tile['label']['type']) and $sf_options_tile['label']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_address_search"><?php _e('Address', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][address_search][type]" id="mec_sf_tile_address_search">
						<option value="0" <?php if(isset($sf_options_tile['address_search']) and isset($sf_options_tile['address_search']['type']) and $sf_options_tile['address_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="address_input" <?php if(isset($sf_options_tile['address_search']) and isset($sf_options_tile['address_search']['type']) and $sf_options_tile['address_search']['type'] == 'address_input') echo 'selected="selected"'; ?>><?php _e('Address Input', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_event_cost"><?php _e('Event Cost', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][event_cost][type]" id="mec_sf_tile_event_cost">
                        <option value="0" <?php if(isset($sf_options_tile['event_cost']) and isset($sf_options_tile['event_cost']['type']) and $sf_options_tile['event_cost']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="minmax" <?php if(isset($sf_options_tile['event_cost']) and isset($sf_options_tile['event_cost']['type']) and $sf_options_tile['event_cost']['type'] == 'minmax') echo 'selected="selected"'; ?>><?php _e('Min / Max Inputs', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_month_filter"><?php _e('Month Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][month_filter][type]" id="mec_sf_tile_month_filter">
                        <option value="0" <?php if(isset($sf_options_tile['month_filter']) and isset($sf_options_tile['month_filter']['type']) and $sf_options_tile['month_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_tile['month_filter']) and isset($sf_options_tile['month_filter']['type']) and $sf_options_tile['month_filter']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Dropdown', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_time_filter"><?php _e('Time Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][time_filter][type]" id="mec_sf_tile_time_filter">
                        <option value="0" <?php if(isset($sf_options_tile['time_filter']) and isset($sf_options_tile['time_filter']['type']) and $sf_options_tile['time_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="local-time-picker" <?php if(isset($sf_options_tile['time_filter']) and isset($sf_options_tile['time_filter']['type']) and $sf_options_tile['time_filter']['type'] == 'local-time-picker') echo 'selected="selected"'; ?>><?php _e('Local Time Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_tile_text_search"><?php _e('Text Search', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][tile][text_search][type]" id="mec_sf_tile_text_search">
                        <option value="0" <?php if(isset($sf_options_tile['text_search']) and isset($sf_options_tile['text_search']['type']) and $sf_options_tile['text_search']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="text_input" <?php if(isset($sf_options_tile['text_search']) and isset($sf_options_tile['text_search']['type']) and $sf_options_tile['text_search']['type'] == 'text_input') echo 'selected="selected"'; ?>><?php _e('Text Input', 'mec'); ?></option>
                    </select>
                </div>
