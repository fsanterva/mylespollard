        ...
        <div class="mec-create-shortcode-tabs-wrap">
            ...
            <div class="mec-add-booking-tabs-right">
                <div class="mec-form-row mec-create-shortcode-tab-content mec-tab-active" id="mec_select_categories">
                    ...
                    <p class="description" style="color: red;"><?php _e('You will see only those categories that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_locations">
                    ...
                    <p class="description" style="color: red;"><?php _e('You will see only those locations that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_organizers">
                    ...
                    <p class="description" style="color: red;"><?php _e('You will see only those organizers that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_labels">
                    ...
                    <p class="description" style="color: red;"><?php _e('You will see only those labels that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_tags">
                    ...
                    <p class="description"><?php _e('Insert your desired tags separated by commas.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_occurrences">
                    ...
                    <div class="mec-form-row mec-switcher">
                        <div class="mec-col-4">
                            <label for="mec_show_past_events"><?php esc_html_e('Show only one occurrence of events', 'mec'); ?></label>
                        </div>
                        <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_holding_statuses">
                    <h4><?php _e('Expired Events', 'mec'); ?></h4>
                    <div class="mec-form-row mec-switcher">
                        ...
                        <p class="description"><?php _e('You can include past/expired events if you like so it will show upcoming and expired events based on start date that you selected.', 'mec'); ?></p>
                    </div>
                    <div id="mec_date_only_past_filter">
                        <div class="mec-form-row mec-switcher">
                            ...
                            <p class="description" style="color: red;"><?php echo sprintf(__('It shows %s expired/past events. It will use the selected start date as first day and then go to %s dates.', 'mec'), '<strong>'.__('only', 'mec').'</strong>', '<strong>'.__('older', 'mec').'</strong>'); ?></p>
                        </div>
                    </div>
                    <div id="mec_date_ongoing_filter">
                        <h4><?php _e('Ongoing Events', 'mec'); ?></h4>
                        <div class="mec-form-row mec-switcher">
                            <?php $show_ongoing_events = get_post_meta($post->ID, 'show_ongoing_events', true); ?>
                            <div class="mec-col-4">
                                <label for="mec_show_ongoing_events"><?php _e('Include Ongoing Events', 'mec'); ?></label>
                            </div>
                            <div class="mec-col-4">
                            ...
                            <p class="description"><?php _e('It includes ongoing events on List, Grid, Agenda and Timeline skins.', 'mec'); ?></p>
                        </div>
                        <div class="mec-form-row mec-switcher">
                            ...
                            <p class="description"><?php _e('It shows only ongoing events on List, Grid, Agenda and Timeline skins.', 'mec'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
