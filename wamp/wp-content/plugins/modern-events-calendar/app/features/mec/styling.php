                ...
                <div class="mec-container">
                    <form id="mec_styling_form">
                        <div class="mec-options-fields">
                            <h2><?php _e('Styling Options', 'mec'); ?></h2>
                        <!-- Colorskin -->
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Color Skin', 'mec' ); ?></h5>
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_dark_mode"><?php _e('Dark Mode', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box top">
                                            <h5 class="title"><?php _e('Dark Mode', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('Enable it to turn on dark mode', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/style-options/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>    
                                        </div>
                            ...
                            <!-- Advanced Options -->
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Advanced Color Options (shortcodes)', 'mec' ); ?></h5>
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <span><?php esc_html_e('Title', 'mec' ); ?></span>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <span><?php esc_html_e('Title Hover', 'mec' ); ?></span>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <span><?php esc_html_e('Content', 'mec' ); ?></span>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <!-- Typography -->
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Typography', 'mec' ); ?></h5>
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box top">
                                            ...
                                            <div class="content"><p><?php esc_attr_e('To be GDPR compliant you may need to disable Google fonts! set "Default Font" value for font family and enable this option.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/style-options/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>    
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <!-- Container Width -->
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Container Width', 'mec' ); ?></h5>
                            <div class="mec-form-row">
                            ...
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Other Styling Option', 'mec' ); ?></h5>

                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <span><?php esc_html_e('Frontend Event Submission Color', 'mec' ); ?></span>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <span><?php esc_html_e('Notifications Background', 'mec' ); ?></span>
                                </div>
                                <div class="mec-col-9">
