...
class MEC_feature_mec extends MEC_base
{
    ...
    public function menus()
    {
        ...
        add_submenu_page('mec-intro', __('Shortcodes', 'mec'), __('Shortcodes', 'mec'), 'mec_shortcodes', 'edit.php?post_type=mec_calendars');
        add_submenu_page('mec-intro', __('MEC - Settings', 'mec'), __('Settings', 'mec'), 'mec_settings', 'MEC-settings', array($this, 'page'));
        ...
        {
            add_submenu_page('mec-intro', __('MEC - Report', 'mec'), __('Report', 'mec'), 'mec_report', 'MEC-report', array($this, 'report'));
        }
        ...
        return '<div class="mec-form-row mec-sed-method-wrap">
            ...
            <div class="mec-col-8">
                ...
                <ul class="mec-sed-methods" data-for="#mec_skin_'.$skin.'_sed_method_field">
                    <li data-method="0" class="'.(!$value ? 'active' : '').'">'.__('Current Window', 'mec').'</li>
                    <li data-method="new" class="'.($value === 'new' ? 'active' : '').'">'.__('New Window', 'mec').'</li>
                    <li data-method="m1" class="'.($value === 'm1' ? 'active' : '').'">'.__('Modal Popup', 'mec').'</li>
                    <li data-method="no" class="'.($value === 'no' ? 'active' : '').'">'.__('Disable Link', 'mec').'</li>
                </ul>
            </div>
    ...
    public function display_organizer_field($skin, $value = 0)
    {
        return '<div class="mec-form-row mec-display-organizer-wrap mec-switcher">
            <div class="mec-col-4">
                <label for="mec_skin_'.$skin.'_display_organizer">'.__('Display Organizers', 'mec').'</label>
            </div>
            <div class="mec-col-4">
