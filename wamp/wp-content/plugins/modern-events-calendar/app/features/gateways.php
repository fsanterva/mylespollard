...
class MEC_gateway_stripe extends MEC_gateway
{
    ...
    public function do_transaction($transaction_id = null)
    {
        ...
        $this->response(
            array(
                'success' => 1,
                'message' => stripslashes($this->main->m('book_success_message', __('Thank you for booking. Your tickets are booked, booking verification might be needed, please check your email.', 'mec'))),
                'data' => array(
                    'book_id' => $book_id,
