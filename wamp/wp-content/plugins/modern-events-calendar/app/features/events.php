...
class MEC_feature_events extends MEC_base
{
    ...
    public function add_category_fields()
    {
        ...
        <?php if($fallback): ?>
        <div class="form-field">
            <label for="mec_thumbnail_button"><?php _e('Fallback Image', 'mec'); ?></label>
    ...
    public function edit_category_fields($term)
    {
        ...
        <tr class="form-field">
            ...
            <td>
                ...
                <button type="button" class="mec_upload_image_button button" id="mec_thumbnail_button"><?php echo __('Upload/Add image', 'mec'); ?></button>
                <button type="button" class="mec_remove_image_button button <?php echo (!trim($fallback_image) ? 'mec-util-hidden' : ''); ?>"><?php echo __('Remove image', 'mec'); ?></button>
            </td>
        </tr>
        <?php endif; ?>
        <?php
                        ...
                        <div class="mec-form-row">
                            <div class="mec-col-12">
                                ...
                                <div class="mec-form-row">
                                    ...
                                    <div class="mec-col-5">
                                        <button class="button" type="button" id="mec_add_in_days" data-allday="<?php echo $allday; ?>"><?php _e('Add', 'mec'); ?></button>
                                        <span class="mec-tooltip">
                                            <div class="box top">
    ...
    ?>
        <div class="mec-add-booking-tabs-wrap">
            <div class="mec-add-booking-tabs-left">
                ...
                <a class="mec-add-booking-tabs-link" data-href="mec_meta_box_booking_options_form_gateways_per_event" href="#"><?php echo esc_html__('Payment Gateways','mec'); ?></a>
                <?php endif; ?>
    ...
    public function meta_box_booking_options($post)
    {
        ...
        <div id="mec-booking">
            <div class="mec-meta-box-fields mec-booking-tab-content mec-tab-active" id="mec_meta_box_booking_options_form_1">
                ...
                <h4 class="mec-title"><?php _e('Discount per user roles', 'mec'); ?></h4>
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="text" name="mec[booking][roles_discount_<?php echo $role_key; ?>]" id="mec_bookings_roles_discount_<?php echo $role_key; ?>" value="<?php echo esc_attr($role_discount); ?>" placeholder="<?php _e('5', 'mec'); ?>">
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
                ...
                <h4 class="mec-title"><?php _e('Interval Options', 'mec'); ?></h4>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_booking_show_booking_form_interval"><?php _e('Show Booking Form Interval', 'mec'); ?></label>
                    <div class="mec-col-4">
                ...
                <h4><?php _e('Automatic Approval', 'mec'); ?></h4>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_booking_auto_verify"><?php _e('Email Verification', 'mec'); ?></label>
                    <div class="mec-col-4">
                        <select name="mec[booking][auto_verify]" id="mec_booking_auto_verify">
                            <option value="global" <?php if(isset($booking_options['auto_verify']) and 'global' == $booking_options['auto_verify']) echo 'selected="selected"'; ?>><?php _e('Inherit from global options', 'mec'); ?></option>
                            <option value="0" <?php if(isset($booking_options['auto_verify']) and '0' == $booking_options['auto_verify']) echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                            <option value="1" <?php if(isset($booking_options['auto_verify']) and '1' == $booking_options['auto_verify']) echo 'selected="selected"'; ?>><?php _e('Enabled', 'mec'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_booking_auto_confirm"><?php _e('Booking Confirmation', 'mec'); ?></label>
                    <div class="mec-col-4">
                        <select name="mec[booking][auto_confirm]" id="mec_booking_auto_confirm">
                            <option value="global" <?php if(isset($booking_options['auto_confirm']) and 'global' == $booking_options['auto_confirm']) echo 'selected="selected"'; ?>><?php _e('Inherit from global options', 'mec'); ?></option>
                            <option value="0" <?php if(isset($booking_options['auto_confirm']) and '0' == $booking_options['auto_confirm']) echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                            <option value="1" <?php if(isset($booking_options['auto_confirm']) and '1' == $booking_options['auto_confirm']) echo 'selected="selected"'; ?>><?php _e('Enabled', 'mec'); ?></option>
                        </select>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="mec-form-row">
                    <h4 class="mec-title"><?php _e('Last Few Tickets Percentage', 'mec'); ?></h4>
                    <div class="mec-form-row">
                        ...
                        <input class="mec-col-4" <?php echo ($bookings_last_few_tickets_percentage_inherite == 1) ? 'style="display: none;"' : ''; ?> type="number" min="1" max="100" step="1" name="mec[booking][last_few_tickets_percentage]" value="<?php echo esc_attr($bookings_last_few_tickets_percentage); ?>" placeholder="<?php _e('15', 'mec'); ?>"/>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="mec-meta-box-fields mec-booking-tab-content" id="mec_meta_box_booking_options_form_gateways_per_event">
                <h4 class="mec-title"><?php _e('Disabled Gateways', 'mec'); ?></h4>
        ...
        <div class="mec-meta-box-fields mec-booking-tab-content" id="mec-tickets">
                        ...
                        <div class="mec-box" id="mec_ticket_row<?php echo $key; ?>">
                            ...
                            <div class="mec-form-row wn-ticket-time">
                                <div class="mec-ticket-start-time mec-col-12">
                                    <span class="mec-ticket-time"><?php esc_html_e('Start Time', 'mec'); ?></span>
                                    <?php $this->main->timepicker(array(
                                        'method' => (isset($this->settings['time_format']) ? $this->settings['time_format'] : 12),
                                ...
                                <div class="mec-ticket-end-time mec-ticket-start-time mec-col-12">
                                    <span class="mec-ticket-time"><?php esc_html_e('End Time', 'mec'); ?></span>
                                    <?php $this->main->timepicker(array(
                                        'method' => (isset($this->settings['time_format']) ? $this->settings['time_format'] : 12),
                            ...
                            <div class="mec-form-row">
                                ...
                                <span class="mec-tooltip">
                                    <div class="box top">
                                        <h5 class="title"><?php _e('Private Description', 'mec'); ?></h5>
                                        <div class="content"><p><?php esc_attr_e("You can show it on the email notifications by placing %%ticket_private_description%% into the email template.", 'mec'); ?></p></div>
                                    </div>
                                    <i title="" class="dashicons-before dashicons-editor-help"></i>
                                </span>
                            </div>
                            ...
                            <div class="mec-form-row">
                                <?php ob_start(); ?>
                                <input type="number" class="mec-stop-selling-tickets" name="mec[tickets][<?php echo $key; ?>][stop_selling_value]" value="<?php echo((isset($ticket['stop_selling_value']) and trim($ticket['stop_selling_value'])) ? esc_attr($ticket['stop_selling_value']) : '0'); ?>" placeholder="<?php _e('e.g. 0', 'mec'); ?>">
            ...
            <div class="mec-util-hidden" id="mec_new_ticket_raw">
                <div class="mec-box" id="mec_ticket_row:i:">
                    ...
                    <div class="mec-form-row">
                        <?php ob_start(); ?>
                        <input type="number" class="mec-stop-selling-tickets" name="mec[tickets][:i:][stop_selling_value]" value="0" placeholder="<?php _e('e.g. 0', 'mec'); ?>">
    ...
    public function meta_box_regform($post)
    {
        ...
        <div class="mec-meta-box-fields mec-booking-tab-content" id="mec-reg-fields">
            ...
            <?php if($post->ID != $this->main->get_original_event($post->ID)) : ?>
            <p class="warning-msg"><?php _e("You're translating an event so MEC will use the original event for booking form. You can only translate the field name and options. Please define exact fields that you defined in the original event here.", 'mec'); ?></p>
            <?php endif; ?>
    ...
    public function filter_columns($columns)
    {
        ...
        // Sold Tickets
        if($this->getPRO() and (isset($this->settings['booking_status']) and $this->settings['booking_status'])) $columns['sold_tickets'] = __('Sold Tickets', 'mec');
        ...
        if ($post_type == $this->PT) {
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    jQuery('<option>').val('ical-export').text('<?php echo __('iCal / Outlook Export', 'mec'); ?>').appendTo("select[name='action']");
                    jQuery('<option>').val('ical-export').text('<?php echo __('iCal / Outlook Export', 'mec'); ?>').appendTo("select[name='action2']");
    ...
    public function do_bulk_actions()
    {
        ...
        switch($action)
        {
            ...
            case 'ms-excel-export':
                ...
                $post_ids = $_GET['post'];
                $columns = array(__('ID', 'mec'), __('Title', 'mec'), __('Description', 'mec'), __('Start Date', 'mec'), __('Start Time', 'mec'), __('End Date', 'mec'), __('End Time', 'mec'), __('Link', 'mec'), $this->main->m('taxonomy_location', __('Location', 'mec')), __('Address', 'mec'), $this->main->m('taxonomy_organizer', __('Organizer', 'mec')), sprintf(__('%s Tel', 'mec'), $this->main->m('taxonomy_organizer', __('Organizer', 'mec'))), sprintf(__('%s Email', 'mec'), $this->main->m('taxonomy_organizer', __('Organizer', 'mec'))), $this->main->m('event_cost', __('Event Cost', 'mec')), __('Featured Image', 'mec'));
