        ...
        <tr class="form-field">
            ...
            <td>
                <select name="style" id="mec_style">
                    ...
                    <option value="mec-label-custom" <?php echo ($style == 'mec-label-custom' ? 'selected="selected"' : ''); ?>><?php _e('Custom', 'mec'); ?></option>
                </select>
                <p class="description"><?php _e('You can show featured, canceled and custom labels by a different style!', 'mec'); ?></p>
            </td>
        </tr>
    <?php
    }
    ...
    ?>
        ...
        <div class="form-field">
            ...
            <select name="style" id="mec_style">
                ...
                <option value="mec-label-custom"><?php _e('Custom', 'mec'); ?></option>
            </select>
            <p class="description"><?php _e('You can show featured, canceled and custom labels by a different style!', 'mec'); ?></p>
        </div>
    <?php
