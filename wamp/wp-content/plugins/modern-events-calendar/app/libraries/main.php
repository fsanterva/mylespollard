...
class MEC_main extends MEC_base
{
    ...
    public function get_sidebar_menu($active_menu = 'settings')
    {
        ...
        $settings = apply_filters('mec-settings-items-settings', array(
            ...
            __('Email Options', 'mec') => 'email_option',
        ...
        if($this->getPRO())
        {
            $messages = array(
                ...
                'others'=>array(
                    ...
                    'messages'=>array(
                        'book_success_message'=>array('label'=>__('Booking Success Message', 'mec'), 'default'=>__('Thank you for booking. Your tickets are booked, booking verification might be needed, please check your email.', 'mec')),
