...
class seniman_post_block extends Widget_Base {

	public function get_name() {
		return 'seniman-post-block';
	}

	public function get_title() {
		return __( 'Post', 'seniman' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_seniman_post_block_element_setting',
			[
		...
		$this->add_control(
			'post_pilih_layout',
			[
				'label' => __( 'Post Layouts', 'seniman' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_grid_layout',
				'options' => [
					'post_grid_layout' => __( 'Post Grid', 'seniman' ),
					'post_masonry_layout'=> __( 'Post Masonry', 'seniman' ),
				],
			]
		);
		...
		$this->add_control(
			'post_grid_style',
			[
				'label' => __( 'Post Grid Styles', 'seniman' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_grid_style1',
				'options' => [
					'post_grid_style1' => __( 'Post Grid 1', 'seniman' ),
					'post_grid_style2' => __( 'Post Grid 2', 'seniman' ),
					'post_grid_style3' => __( 'Post Grid 3', 'seniman' ),
					'post_grid_style4' => __( 'Post Grid 4', 'seniman' ),
					'post_grid_style5' => __( 'Post Grid 5', 'seniman' ),
				],
				'condition' => [
		...
		$this->add_control(
			'post_masonry_style',
			[
				'label' => __( 'Post Masonry Styles', 'seniman' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_masonry_style1',
				'options' => [
					'post_masonry_style1' => __( 'Post Masonry 1', 'seniman' ),
				],
				'condition' => [
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_seniman_post_block_post_setting',
			[
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_seniman_post_block_layout_setting',
			[
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_seniman_post_block_image_setting',
			[
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'For Default Post Style, only work when assigned as horizontal item.', 'seniman' ),
				'condition' => [
		...
		$this->add_responsive_control(
			'allow_float_img',
			[
				'label' => __( 'Make Image Above Text', 'seniman' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left' => __( 'Image Beside Content', 'seniman' ),
					'none' => __( 'Image Above Content', 'seniman' ),
				],
				'selectors' => [
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_seniman_post_block_scroll_setting',
			[
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
		'section_seniman_post_block_title_style_setting',
			[
		...
		$this->add_control(
			...
			[
				'label' => __( 'Title Hover Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#666666',
				'selectors' => [
		...
		$this->add_responsive_control(
			'title_min_height',
			[
				'label' => __( 'Title Minimum Height', 'seniman' ),
				'description' => __( 'Use in case you want to make all title have same height.', 'seniman' ),
		...
		/*====== 6.1. Category Style Setting =======*/
		$this->start_controls_section(
		'section_seniman_post_block_category_style_setting',
			[
		...
		$this->add_control(
			'use_category',
			[
				'label' => __( 'Use Category Text', 'seniman' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		$this->add_responsive_control(
			'text_align_category',
			[
				'label' => __( 'Category Align', 'seniman' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'seniman' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Border Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Text Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Background Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#61c436',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Link Hover Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Background Hover', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#61c436',
				'selectors' => [
		...
		/*====== 6.2. Author Style Setting =======*/
		$this->start_controls_section(
		'section_seniman_post_block_author_style_setting',
			[
		...
		$this->add_control(
			'use_author',
			[
				'label' => __( 'Use Author Text', 'seniman' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Author Text Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Author Link Hover Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		/*====== 6.3. Date Style Setting =======*/
		$this->start_controls_section(
		'section_seniman_post_block_date_style_setting',
			[
		...
		$this->add_control(
			'use_date',
			[
				'label' => __( 'Use Date Text', 'seniman' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Date Text Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			'date_link_hov_color',
			[
				'label' => __( 'Date Link Hover Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Date Font Setting', 'seniman' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_4,
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
		'section_seniman_post_block_excerpt_style_setting',
			[
		...
		$this->add_control(
			'use_excerpt',
			[
				'label' => __( 'Use Excerpt Block', 'seniman' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'typography_post_excerpt_post',
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
		'section_seniman_post_block_readmore_style_setting',
			[
		...
		$this->add_control(
			'use_read_more',
			[
				'label' => __( 'Use Read More', 'seniman' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		$this->add_responsive_control(
			'text_align_more',
			[
				'label' => __( 'Read More Align', 'seniman' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'seniman' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Title Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Background Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Background Hover', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Hover Background Color', 'seniman' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Read More Font Setting', 'seniman' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_3,
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_seniman_post_pagination_style_setting',
			[
...
Plugin::instance()->widgets_manager->register_widget_type( new seniman_post_block() );