...
add_action( 'elementor/element/seniman-post-block/section_seniman_post_pagination_style_setting/after_section_start', function( $element, $args ) {
	...
	$element->add_control(
		...
		[
			...
			'options' => [
				'post_pagination_none' => __( 'No Pagination', 'seniman' ),
				'post_pagination_number' => __( 'Pagination Number', 'seniman' ),
				'post_pagination_nexprev'=> __( 'Pagination Next/Prev', 'seniman' ),
				'post_pagination_infinite'=> __( 'Pagination Infinite', 'seniman' ),
			],
		]
	);
