...
class seniman_portfolio_pagination extends Widget_Base {

	public function get_name() {
		return 'seniman-portfolio-page';
	}

	public function get_title() {
		return __( 'Pagination', 'seniman' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'seniman_portfolio_pagination_control',
			[
		...
		$this->add_control(
			'color_text_block',
			[
				'label' => __( 'Pagination Color', 'seniman' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new seniman_portfolio_pagination() );