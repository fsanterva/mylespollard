...
<!-- Header
		============================================= -->
		<header id="header" class="header-style-6 inner-head-wrap<?php if($seniman_header_animated == '1') { ?> animated<?php } ?> <?php if(class_exists( 'acf' ) && !is_search() && $seniman_header_style_choice == 'alternative'){ ?>alt-head <?php } ?>clearfix">
