...
function seniman_footer_widget_ext_opt() {

	$seniman_footer_widget_opt = array(
		...
		array(
			...
			'type' => 'image_select',
			'compiler'=>true,
			'title' => esc_html__('Footer Widget Layout', 'seniman'), 
			'subtitle' => esc_html__('Select footer and widget alignment. Choose between 1, 2, 3 or 4 column layout.', 'seniman'),
			'options' => array(
		...
		array(
			...
			'units_extended'=> 'true',
			'display_units' => 'true',
			'title'    => __( 'Padding Footer Widget', 'seniman' ),
			'default'  => array(
				'padding-top'    => '0',
				'padding-right'  => '0',
				'padding-bottom' => '0',
		...
		array(
			...
			'units_extended'=> 'true',
			'display_units' => 'true',
			'title'    => __( 'Padding Footer Bottom', 'seniman' ),
			'default'  => array(
				'padding-top'    => '0',
				'padding-right'  => '0',
				'padding-bottom' => '0',
		...
		array(
			...
			'type'     => 'border',
			'title'    => __( 'Footer Widget Border', 'seniman' ),
		...
		array(
			...
			'type'     => 'border',
			'title'    => __( 'Footer Bottom Border', 'seniman' ),
...
return $seniman_footer_widget_opt;
}